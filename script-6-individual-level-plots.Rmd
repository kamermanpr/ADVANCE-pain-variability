---
title: "Script 6"
subtitle: "Individual-level pub;ication plots"
...
# knitr options
knitr::opts_chunk$set(fig.path = './figures/script-6/')
```
...
df_number %>% 
    ...
    knitr::kable(caption = 'Mean number of pain sites in people with pain')
